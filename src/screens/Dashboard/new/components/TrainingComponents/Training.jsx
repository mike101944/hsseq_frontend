...
const [progressValue,setProgressValue]=useState(0);
  ...
  return (
    <div className='trainig-container'>
        ...
        <div className='bg-gradient-to-tr from-blue-400 via-teal-200 to-blue-400 py-2  font-semibold text-blue-300 rounded-b-lg'>
                <span>Manage Trg</span><i class='bx bx-dots-horizontal-rounded icon' style={{fontSize: "23px",color:"#8a93a0"}}></i>
        </div>
