...
export function SolidWaste() {
    const DataTable = Array.from({ length: 23 }, (_, index) => ({
        id: index + 1,
        sn: index + 1
    }));
  ...
  return (
    ...
    <div className="flex flex-row  justify-between items-center w-full bg-white p-4 mb-3 shadow-md rounded-xl ">
        ...
        <div className="flex flex-row gap-4 items-center justify-center">
          <span className='font-bold text-sky-500'>Solid Waste</span>
...
<table className="w-full self-center border-collapse bg-white shadow-md rounded-lg font-sans">
