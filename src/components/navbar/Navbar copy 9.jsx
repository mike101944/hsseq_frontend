  ...
  <div className="p-4 border-t border-gray-100 bg-gray-50/30">
    <div className="flex items-center justify-center gap-4">
      ...
      <button className="text-sm text-white bg-[#00A859] hover:bg-[#00A859]/90 font-medium px-4 py-2 rounded-lg transition-colors flex items-center gap-2">
        ...
        <PopoverTrigger asChild>
  <button className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200 group relative">
    {/* Online Status Indicator */}
    <div className="relative">
      <div className="absolute -top-0.5 -right-0.5 w-3 h-3 bg-green-500 border-2 border-white dark:border-gray-900 rounded-full z-10" />
      <Avatar className="h-9 w-9 ring-2 ring-white dark:ring-gray-800 shadow-sm group-hover:ring-[#00A859]/20 transition-all">
        <AvatarFallback className="bg-gradient-to-br from-[#00A859] to-[#1E3A34] text-white font-semibold text-sm group-hover:scale-105 transition-transform">
    ...
    {/* Hover Glow Effect */}
    <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-transparent via-[#00A859]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity -z-10" />
  </button>
</PopoverTrigger>
    ...
    <div className="p-4 border-t border-gray-100 bg-gray-50/50">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-[#FF8C00] to-[#FF6B00] hover:from-[#FF6B00] hover:to-[#FF8C00] rounded-lg transition-all shadow-sm hover:shadow"
        >
