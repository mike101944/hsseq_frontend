...
export function Navbar({ toggleSidebar }) {
  ...
  <button className="relative p-2.5 rounded-full hover:bg-amber-50/50 transition-all duration-200 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-200">
    {/* Message icon with golden glow */}
    <MessageSquare className="w-5 h-5 text-amber-700 group-hover:text-amber-800 transition-colors" />
    
    {/* Premium badge with camel oil colors */}
    <span className="absolute -top-1 -right-1 min-w-5 h-5 bg-linear-to-br from-amber-500 to-amber-700 text-amber-50 text-xs font-semibold rounded-full flex items-center justify-center px-1 shadow-lg shadow-amber-500/30 border border-amber-200">
      3
    </span>
    
    {/* Subtle sand particle effect on hover */}
    <span className="absolute inset-0 rounded-full bg-linear-to-r from-amber-50/0 via-amber-100/20 to-amber-50/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
  </button>
</PopoverTrigger>
