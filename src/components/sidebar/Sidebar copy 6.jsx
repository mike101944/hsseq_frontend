      ...
      return (
        <li key={module.id}>
          <div className="relative group">
            ...
            {/* Clickable Tooltip for collapsed state */}
            {hoveredModule === module.id && (
              <div 
                ...
                onMouseLeave={() => setHoveredModule(null)}
              >
                <div className="bg-gray-900 text-white rounded-lg shadow-xl min-w-48">
                  {/* Tooltip header */}
                  <div 
                    className="px-3 py-2 border-b border-gray-700 cursor-pointer hover:bg-gray-800 rounded-t-lg"
                    onClick={() => handleCollapsedModuleClick(module)}
                  >
