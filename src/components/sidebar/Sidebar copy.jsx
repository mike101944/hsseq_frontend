  ...
  return (
    <>
      ...
      >
        ...
        {/* Sidebar header - Hidden when collapsed except on mobile */}
        ...
        {/* {!isMobile && (
          <div className="absolute top-4 -right-3 z-30">
            <button
              ...
              className="w-6 h-6 bg-green-700/65 border-2 border-green-600 rounded-full flex items-center justify-center hover:bg-green-600 transition-all shadow-lg"
            >
              {sidebarCollapsed ? (
