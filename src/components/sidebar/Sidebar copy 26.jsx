...
export const Sidebar = forwardRef(({
  ...
  const getSidebarClasses = () => {
    const base = `
      h-full bg-white
      border-r border-gray-200 flex flex-col p-4 pl-0 pr-0 transition-all duration-1300
    `;
    ...
    if (sidebarCollapsed) {
      return `${base} relative z-40  overflow-visible`;
    }
        ...
        <li key={module.id} className="relative z-50"> 
          ...
          >
            <button
              ...
              className={`w-full/2 flex items-center justify-center px-3 py-3  transition-all duration-200 mx-2
                ${isActive
              ...
              {module.subItems.map((sub) => {
                ...
                return (
                  <li key={sub.id}>
                    <button
                      onClick={() => handleNavigation(sub.path)}
                      className={`w-full flex items-center px-4 py-2 cursor-pointer transition-all duration-600 text-sm
                      ${
                        active
