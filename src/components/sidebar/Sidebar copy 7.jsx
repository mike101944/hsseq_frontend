...
export const Sidebar = forwardRef(({ 
  ...
  const getSidebarClasses = () => {
    const baseClasses = `
      ...
      shadow-2xl shadow-green-900/50 flex flex-col p-4 transition-all duration-300 z-30
      overflow-x-hidden
    `;
      ...
      return (
        <li key={module.id}>
          <div className="relative">
            ...
            {/* Clickable Tooltip for collapsed state - HIGHER Z-INDEX */}
  ...
  return (
    <>
      ...
      >
        ...
        {!isMobile && (
          <div className="absolute top-4 -right-3 translate-z-80">
            <button
