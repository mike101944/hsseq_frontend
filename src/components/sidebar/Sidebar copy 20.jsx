...
export const Sidebar = forwardRef(
  (
    ...
    const isActivePath = (path) =>
      ...
      // h-full bg-gradient-to-b from-green-50 to-green-100 border-r border-green-600
    const getSidebarClasses = () => {
      const base = `
      h-full bg-white
      shadow-xl shadow-green-900/50 flex flex-col p-4 pl-0 pr-0 transition-all duration-300 overflow-x-hidden
    `;
      if (isMobile)
        ...
        <li key={module.id}>
          <div className="space-y-4">
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-3 cursor-pointer  transition-all duration-200
              ${
                isActive
                  ? "bg-green-200/50 text-green-700 shadow-lg border-r-2 border-green-500/45"
                  : "text-green-100 hover:drop-shadow-lg hover:text-white"
              }`}
            >
