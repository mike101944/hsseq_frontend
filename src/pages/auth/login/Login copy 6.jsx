        ...
        <div>
          ...
          <div className="max-w-lg">
            <h2 className="text-4xl font-bold mb-6 leading-tight">
              Transform Your Safety & Compliance Management
            </h2>
            <p className="text-emerald-100 text-lg mb-10">
              Enterprise-grade platform for Health, Safety, Security, Environment, 
              and Quality management. Streamline operations, ensure compliance, 
            ...
            <div className="grid grid-cols-2 gap-6 mb">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-emerald-200 text-sm">Identify & mitigate risks</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="p-2 bg-white/10 rounded-lg">
        ...
        <div className="border-t border-emerald-700/50 pt-3">
          <div className="flex items-center justify-between">
            <div className="text-emerald-200 text-sm">
              © 2024 HSSEQ Platform. All rights reserved.
            </div>
