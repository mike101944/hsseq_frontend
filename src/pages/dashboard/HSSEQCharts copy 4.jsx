                  ...
                  <div key={event.id} className="flex items-start gap-3 group hover:bg-gray-50 p-2 rounded-lg transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <div className={`w-2 h-2 rounded-full ${event.color === 'blue' ? 'bg-blue-500' : event.color === 'red' ? 'bg-red-500' : event.color === 'green' ? 'bg-green-500' : event.color === 'purple' ? 'bg-purple-500' : 'bg-amber-500'}`}></div>
                        <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${event.color === 'blue' ? 'bg-blue-100 text-blue-700' : event.color === 'red' ? 'bg-red-100 text-red-700' : event.color === 'green' ? 'bg-green-100 text-green-700' : event.color === 'purple' ? 'bg-purple-100 text-purple-700' : 'bg-amber-100 text-amber-700'}`}>
                          {event.type}
                        </span>
