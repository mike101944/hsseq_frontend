    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            ISO 45001 Compliant HSSEQ Incident Management
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button className="cursor-pointer bg-emerald-600 text-white font-bold gap-2 hover:bg-emerald-700">
      ...
      <Card className="border-none shadow-sm">
        <CardHeader>
          ...
          <CardDescription>
            ISO 45001 Complaint Incident Management Workflow
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-5 gap-4">
            {["Draft", "Review", "Investigation", "CAPA", "Closed"].map(
              (step, index) => (
