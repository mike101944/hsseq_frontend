...
export function Incidents() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h4 className="text-3xl font-bold tracking-tight text-gray-900">Incident Management System</h4>
          <p className="text-gray-600 mt-1">ISO 45001 Compliant HSSEQ Incident Management</p>
        </div>
        <div className="flex gap-2">
          <Dialog>
            <DialogTrigger asChild>
              <Button  className="gap-2 bg-white hover:bg-green-50 cursor-pointer text-emerald-700 font-semibold shadow-m shadow-emerald-400">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button className="cursor-pointer bg-emerald-600 text-white font-bold gap-2">
  ...
  <div className="sticky top-0 z-10 bg-white border-b px-6 py-4">
    <DialogHeader>
      <DialogTitle className="text-xl font-bold text-gray-900">
        New Incident Report (ISO 45001)
      </DialogTitle>
      <DialogDescription className="text-gray-600">
        Complete all required fields for proper incident documentation and analysis
      </DialogDescription>
    </DialogHeader>
  </div>
  ...
  <div className="space-y-6 px-6 py-4">
              ...
              <SelectContent>
                {severityLevels.map((level) => (
                  ...
                  >
                    ...
                    <span className="text-gray-500 text-sm ml-auto">{level.description}</span>
                  </SelectItem>
                ))}
              </SelectContent>
            </Select>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-gray-500">Add GPS coordinates if available</span>
              </div>
            </div>
          </div>
      ...
      <div className="space-y-3">
        <Label className="text-gray-700 font-medium">
          ...
          <span className="text-sm text-gray-500 font-normal ml-2">
            Include what happened, who was involved, and immediate actions taken
          </span>
        </Label>
        <Textarea 
          placeholder="Provide a detailed account of the incident, including sequence of events, people involved, environmental conditions, and any immediate corrective actions taken..."
          rows={5}
    ...
    {/* Affected Parties */}
    <div className="rounded-lg border bg-gray-50 p-4">
      <h3 className="text-lg font-semibold text-gray-800 mb-4">Affected Parties</h3>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="space-y-2">
          <Label className="text-gray-700">Injured Persons</Label>
          <Input type="number" min="0" placeholder="0" className="h-11" />
        </div>
        <div className="space-y-2">
          <Label className="text-gray-700">Witnesses</Label>
          <Input type="number" min="0" placeholder="0" className="h-11" />
        </div>
        <div className="space-y-2">
          <Label className="text-gray-700">Affected Equipment</Label>
          <Input placeholder="Equipment ID or name" className="h-11" />
        </div>
      </div>
    </div>
    ...
    {/* Evidence Upload */}
    <div className="rounded-lg border bg-gray-50 p-4">
      <h3 className="text-lg font-semibold text-gray-800 mb-4">Evidence & Documentation</h3>
      <div className="space-y-4">
        <div>
          <Label className="text-gray-700 font-medium">Attach Evidence</Label>
          <p className="text-sm text-gray-500 mb-3">
            Photos, videos, documents, or other supporting materials
          </p>
            ...
            <div className="flex flex-col items-center justify-center gap-3 text-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Supports JPEG, PNG, PDF, MP4 up to 10MB each
                </p>
              </div>
            </div>
          </div>
        ...
        {/* File Preview Area */}
        <div className="min-h-[80px] rounded-lg border border-gray-200 p-4">
          <p className="text-sm text-gray-500 text-center">
            No files attached yet. Upload photos, videos, or documents.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="rounded-lg border bg-gray-50 p-4">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          <Label className="text-gray-700">Immediate Actions Taken</Label>
          <Textarea 
            placeholder="Describe immediate actions taken after the incident (first aid, isolation, notifications, etc.)"
            rows={3}
          />
        </div>
        
        <div className="space-y-2">
          <Label className="text-gray-700">Root Cause Analysis</Label>
          <Textarea 
            placeholder="Preliminary analysis of possible root causes (optional)"
            rows={3}
          />
        </div>
        ...
        <div className="flex items-center justify-between p-3 bg-white rounded-lg border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <Label htmlFor="anonymous-report" className="font-medium text-gray-700 cursor-pointer">
    ...
    {/* Footer Actions */}
    <div className="sticky bottom-0 bg-white border-t -mx-6 -mb-4 px-6 py-4 mt-6">
      ...
      <p className="text-xs text-gray-500 text-center mt-3">
        By submitting, you acknowledge this report complies with ISO 45001 requirements
      </p>
    </div>
  </div>
</DialogContent>
